...
import io.pivotal.literx.tasks.basics.Part02ProgrammaticFlux;
...
public class Part02ProgrammaticFluxTest {

    Part02ProgrammaticFlux workshop = new Part02ProgrammaticFlux();
